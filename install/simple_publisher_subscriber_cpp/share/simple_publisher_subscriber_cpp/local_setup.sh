...
: ${AMENT_CURRENT_PREFIX:="/projeto/install/simple_publisher_subscriber_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_publisher_subscriber_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_publisher_subscriber_cpp/environment/path.sh"
